...
automatically identifies and deletes stale EBS snapshots that are not associated with any active EC2 instance. This helps optimize storage usage and reduce AWS costs.st 
